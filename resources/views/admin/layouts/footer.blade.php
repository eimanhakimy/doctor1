 <footer class="footer">
                    <div class="w-100 clearfix">
                        ...
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Create by Eiman Hakimy <i class="fa fa-heart text-danger"></i> by <a href="http://lavalite.org/" class="text-dark" target="_blank">Lavalite</a></span>
                    </div>
                </footer>
