                        ...
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                              ...
                              <!--   <div class="nav-item">
                                ...
                                @if(auth()->check()&& auth()->user()->role->name === 'doctor')
                                   <div class="nav-item has-sub">
                                    <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Customer Appointment</span> <span class="badge badge-danger"></span></a>
                                    <div class="submenu-content">
                                        <a href="{{route('patients.today')}}" class="menu-item">Customer(today)</a>
                                        <a href="{{route('prescribed.patients')}}" class="menu-item">All customer(prescription)</a>
